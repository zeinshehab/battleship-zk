...
- Commit: The defender turns a 10×10 bitboard (1=ship, 0=water) into a 128-leaf MiMC Merkle tree and shares only the root (public commitment).
...
`./battleship verify --vk ./keys/shot.vk --root 0x<ROOT_FROM_COMMIT> --proof proof_3_7.json`
...
`./battleship verify --vk ./keysB/shot.vk --root 0xROOT_B --proof proof_r_c.json`
